...
if (isset($_POST['register'])) {
    ...
    $sql = $koneksi->query("INSERT INTO tb_user (nim, nama, prodi, jenis_kelamin, tanggal_lahir, alamat, motivasi, id_role)VALUES('$nim', '$nama', '$prodi', '$jenis_kelamin', '$tanggal_lahir', '$alamat', '$motivasi' , 2)");
