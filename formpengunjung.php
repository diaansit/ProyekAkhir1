            ...
            <div class="container">
                <div class="signup-content">
                    <div class="signup-form">
                        <h2 class="form-title">Pengunjung</h2>
                        <form method="POST" class="register-form" id="register-form">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="prodi" id="prodi" placeholder="Prodi, Contoh : D3 Teknologi Informasi, S1 Informatika" required />
                            ...
                            <div class="form-group form-button">
                                <input type="submit" name="register" class="form-submit" value="Masuk" />
                            </div>
                        </form>
                    </div>
...
if (isset($_POST['register'])) {
    ...
    $sql = $koneksi->query("INSERT INTO tb_pengunjung (nim, nama, prodi)VALUES('$nim', '$nama', '$prodi')");

    if ($sql) {
?>
        <script>
            alert('Registrasi pengunjung Berhasil!');
